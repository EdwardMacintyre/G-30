...
We cannot use AIC to compare the gamma model and the linear model, since they have different likelihood functions.

Instead, lets perform leave-one-out cross validation to compare the predictive power of the linear model vs the gamma model
...
```{r}
plot(predict(nbmod_2, type = "response")/(data201015_1$pop201015/100000), data201015_1$hrate201015, xlab = "Predicted", ylab = "Actual", main = "Actual vs Predicted hate crime rates")
lines(lowess(predict(nbmod_2, type = "response")/(data201015_1$pop201015/100000), data201015_1$hrate201015),col="red")
abline(a=0,b=1)
